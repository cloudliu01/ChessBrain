...
**Demo Command**: [`python -m chessbrain.interface.cli ...` or NEEDS CLARIFICATION]
...
- [ ] T018 [US1] Document and automate the demo command in docs/quickstart.md or scripts/demo_[story].sh
...
- [ ] T025 [US2] Document and automate the demo command in docs/quickstart.md or scripts/demo_[story].sh
...
- [ ] T031 [US3] Document and automate the demo command in docs/quickstart.md or scripts/demo_[story].sh
...
- [ ] TXXX Capture observability review notes and ensure explainability artifacts are stored
...
```bash
# Launch required tests for User Story 1 first:
...
- Verify tests fail before implementing, then re-run after implementation to confirm pass
